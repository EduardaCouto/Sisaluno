...
<div class="alt">
  <form method="POST" action="crudprofessor.php">
      ...
      <p> ID: <br> <input type="text" name="id" id="" value=<?php echo $id?> > </p>
       ...
       <p> Nome: <br>  <input type="text" name="nome" id="" required value=""<?php echo $nome?> > </p>
                                                
       <p> IDADE: <br> <input type="number" name="idade" id="" min="18" max="50" required<?php echo $idade ?> > </p> 
